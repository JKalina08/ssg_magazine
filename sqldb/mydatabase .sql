...
SET NAMES utf8mb4_czech_ci;

DROP DATABASE IF EXISTS `ssg`;
CREATE DATABASE `ssg`;
USE  `ssg`;

CREATE TABLE `ssg.ssg_users` (
  `id_staff` int(11) NOT NULL,
  `user_name` varchar(100) COLLATE utf8mb4_czech_ci NOT NULL,
  `password` varchar(100) COLLATE utf8mb4_czech_ci NOT NULL,
  `user_full_name` varchar(100) COLLATE utf8mb4_czech_ci NOT NULL,
  `tag` varchar(20) COLLATE utf8mb4_czech_ci NOT NULL,
  `mail` varchar(100) COLLATE utf8mb4_czech_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;

INSERT INTO `ssg.ssg_users` (`id_staff`, `user_name`, `password`, `user_full_name`, `tag`, `mail`) VALUES
...
CREATE TABLE `ssg.ssg_article` (
  `id_art` int(11) NOT NULL,
  `title` varchar(50) COLLATE utf8mb4_czech_ci NOT NULL,
  `file` varchar(128) COLLATE utf8mb4_czech_ci NOT NULL,
  `status` int(11) NOT NULL,
  `theme` varchar(3) COLLATE utf8mb4_czech_ci NOT NULL,
  `autor` int(11) NOT NULL,
  `recenzent1` int(11) NOT NULL,
  `recenze1` varchar(4096) COLLATE utf8mb4_czech_ci NOT NULL,
  `akt1` int(11) NOT NULL,
  `orig1` int(11) NOT NULL,
  `lang1` int(11) NOT NULL,
  `recenzent2` int(11) NOT NULL,
  `recenze2` varchar(4096) COLLATE utf8mb4_czech_ci NOT NULL,
  `akt2` int(11) NOT NULL,
  `orig2` int(11) NOT NULL,
  `lang2` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;

INSERT INTO `ssg.ssg_article` (`id_art`, `title`, `file`, `status`, `theme`, `autor`, `recenzent1`, `recenze1`, `akt1`, `orig1`, `lang1`, `recenzent2`, `recenze2`, `akt2`, `orig2`, `lang2`) VALUES
...
CREATE TABLE `ssg.ssg_autors` (
  `id_art` int(11) NOT NULL,
  `id_staff` int(11) NOT NULL,
  `main` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `sssg.sg_autors` (`id_art`, `id_staff`, `main`) VALUES
(2, 4, 1),
(2, 5, 0),
(3, 5, 1),
(4, 4, 1);

ALTER TABLE `ssg.ssg_autors`
